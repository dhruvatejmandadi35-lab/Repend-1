                                                                                                                                                  ...
                                                                                                                                                  "x": 60, "y": 100,
                                                                                                                                                    "text": "Generation I",
                                                                                                                                                      "size": 12,
                                                                                                                                                        ...
                                                                                                                                                        ────────────────────────────────────────────────
                                                                                                                                                        PATTERN SELECTION — match the topic to the right interaction:
                                                                                                                                                        ────────────────────────────────────────────────
                                                                                                                                                        Think about what the learner is supposed to DO with the concept, then pick the pattern:

                                                                                                                                                        NODE + states-match → for CLASSIFYING / TOGGLING / IDENTIFYING items into discrete categories.
                                                                                                                                                          Examples: pedigrees (affected/unaffected/carrier), cell cycle phase identification, logic gates (on/off), grammatical part of speech, periodic table groups, healthy vs cancerous cells, igneous/sedimentary/metamorphic rocks, Nash equilibrium cells in a payoff matrix, ethical frameworks (deontology/utilitarianism/virtue), constitutional amendment classification, art movement classification, programming language paradigms, market structures (monopoly/oligopoly), bug vs feature triage, true/false historical claims.

                                                                                                                                                        DRAGGABLE + TARGET + snaps-correct → for LABELING parts of a diagram, MATCHING pairs, ORDERING a sequence, or SORTING into bins.
                                                                                                                                                          Examples: organelle labeling, brain regions, planet ordering, French Revolution timeline, OSI network layers, water cycle steps, cooking recipe sequence, weld types matched to use cases, court hierarchy, supply chain stages, musical intervals matched to ear-trained sounds, color theory complementary pairs, philosophical schools matched to philosophers, programming sort algorithms matched to complexity, animal kingdom taxonomy, geological eras in order, sentence diagramming, syllogism premise/conclusion matching, business model canvas blocks, painting composition rule-of-thirds anchors, derivative rules matched to function types, machine learning algorithms matched to problem types.

                                                                                                                                                        SLIDER + values-equal (+ bind to SVG) → for TUNING a quantitative relationship until a target is hit. Sliders update a visible SVG element so the learner SEES the effect.
                                                                                                                                                          Examples: F=ma, projectile range, lens equation focal length, compound interest growth, half-life decay, RC circuit time constant, Doppler shift, supply/demand equilibrium price, Black-Scholes option price, Hardy-Weinberg allele frequency, oscillator frequency vs damping, color RGB→hex, statistical confidence interval width, neural network learning rate vs loss, climate sensitivity to CO2, projectile trajectory under gravity, pendulum period vs length, beam deflection under load, antibiotic dose-response curve, escape velocity by planet mass.

                                                                                                                                                        MIXED (multiple kinds in one lab) → for richer topics that need both classification AND a tunable element, or labeling AND a stateful diagram.
                                                                                                                                                          Examples: ecosystem (drag species into trophic levels + slider for population) | electrical circuit (drag components + slider for voltage + LED brightness binds to current) | rhetoric (classify devices in a speech + slider for persuasion strength).
